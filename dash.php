...
<div class="row">
<div class="col-lg-6">
<span class="logo">School Notification System</span></div>


<?php
include_once 'connection.php';
session_start();
if (!(isset($_SESSION['uname']))  || ($_SESSION['key']) != '54585c506829293a2d4c3b68543b316e2e7a2d277858545a36362e5f39') {
    session_destroy();
...
if (@$_GET['q'] == 1)
    echo 'class="active"';
?>><a href="dash.php?q=1">Add student</a></li>
    <li <?php
if (@$_GET['q'] == 2)
    echo 'class="active"';
?>><a href="dash.php?q=2">add Parents</a></li>
    <li <?php
if (@$_GET['q'] == 3)
    echo 'class="active"';
?>><a href="dash.php?q=3">Add Cashier</a></li>
        <li <?php
if (@$_GET['q'] == 4)
    echo 'class="active"';
?>><a href="dash.php?q=4">Write Notificatio</a></li>
        <li <?php
if (@$_GET['q'] == 5)
    echo 'class="active"';
?>><a href="dash.php?q=5">Feedback</a></li>
      </ul>
          </div>
  </div>
</nav>
